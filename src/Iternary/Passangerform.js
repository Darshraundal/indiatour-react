...
function Passangerform() {
    ...
    const handleSubmit = (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            fetch("http://ec2-44-203-2-236.compute-1.amazonaws.com:8080/passangers", {
                method: 'POST',
                headers: { 'Content-type': 'application/json' },
                body: demo
            }).then(r => { console.log(r.json()); alert(" Passanger has Added Successfully ")
    ...
    useEffect(() => {
        fetch("http://ec2-44-203-2-236.compute-1.amazonaws.com:8080/cost/" + smid)
            .then(res => res.json())
