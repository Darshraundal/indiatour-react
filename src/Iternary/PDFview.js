...
function PDFview() {
    ...
    useEffect(() => {
        fetch("http://ec2-44-203-2-236.compute-1.amazonaws.com:8080/api/auth/customer/"+cid)
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch("http://ec2-44-203-2-236.compute-1.amazonaws.com:8080/packages/" + bkid)
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch(`http://ec2-44-203-2-236.compute-1.amazonaws.com:8080/passanger/${bkid}/${cid}`)
            .then(res => res.json())
    ...
    const handleSubmit = (event) => {
        ...
        fetch("http://ec2-44-203-2-236.compute-1.amazonaws.com:8080/booking", {
            method: 'POST',
